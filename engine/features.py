...
def hotword():
    ...
    try:
        ...
        porcupine = pvporcupine.create(access_key='6R+qJMqUy7Pfv8aw5oPkMMroE4WTExVGQRnkUGWpL1ByXQ5BCgxpXw==',keyword_paths=['C:\\Users\Girish\OneDrive\Desktop\Alita-AI\\alita_Working\Alita_Desktop_AI\engine\\alita keyword\\alita_en_windows_v3_0_0.ppn'])
